package de.pixelate.flixelprimer 
{
	...
	public class SensorBattery
	{
		...
		public function SensorBattery(inst_model:String, inst_mass: Number, inst_eCost:Number, inst_$:Number, inst_accuracy:Number=0.5, inst_precision:Number=0.9)
		{
			//set model name
			model = inst_model;
		...
		public function detectBatteryLevel(actualBatteryLevel:Number):Number
		{
			...
			var detectedBattery:Number = actualBatteryLevel + accuracy + precisionOffset;
			
			trace("Detecting battery level... ", detectedBattery, "Actual battery was ", actualBatteryLevel," Precision offset was ", precisionOffset, "Accuracy was ", accuracy);
			
			return detectedBattery;
		}
