package de.pixelate.flixelprimer 
{
	 ...
	 * @author ...
	 */
	public class SensorDistanceShort
	{
		...
		public function SensorDistanceShort(inst_model:String, inst_mass: Number, inst_eCost:Number, inst_$:Number, inst_accuracy:Number=0.5, inst_precision:Number=0.9)
		{
			//set model name
			model = inst_model;
		...
		public function detectDistanceShort(actualDistance:Number, overallWidth:Number):Boolean
		{
			...
			trace("Detecting distance short ... ", detectedDistance, "Actual distance was ", actualDistance, " Precision offset was ", precisionOffset, "Accuracy was ", accuracy);
			
			//if the detected distance 75% or greater of the total width then return true
			var targetDistance:Number = 0.25 * overallWidth;
